...
> **Analista de Dados (Produto & Growth)** — Este repositório documenta uma investigação sobre o que faz usuários voltarem a jogar o **Palavritas**, o jogo de palavras diário da newsletter **the news
> Candidato: Matheus Araújo Santos**.
>  O foco não é código: é entender comportamento, encontrar alavancas reais de retenção e transformar insights em ações para o time de Produto.
...
*Case Técnico — Analista de Dados (Produto & Growth) | the news  — Matheus Araujo Santos*
